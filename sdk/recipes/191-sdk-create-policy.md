...
This note expands the Foreseen SDK and npm integration guide for sdk create policy.
...
CELO create policy: set bet ≥ 0.01 CELO — matches below minimum bet are rejected by RPSCore on CELO.
