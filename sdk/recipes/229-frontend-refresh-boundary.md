# Frontend Refresh Boundary

This note expands the Foreseen SDK and npm integration guide for frontend refresh boundary.
...
CELO refresh boundary: manual refresh resets the 30s CELO cache — no full page reload needed.
