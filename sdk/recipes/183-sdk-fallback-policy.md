...
This note expands the Foreseen SDK and npm integration guide for sdk fallback policy.
...
CELO fallback policy: if scouting data unavailable, use Move.Paper as CELO default — highest EV against naive players.
