...
This note expands the Foreseen SDK and npm integration guide for sdk agent snippet.
...
CELO agent snippet: pass `privateKey` to `new ForeseenBot()` — bot signs CELO mainnet txs automatically.
