...
This note expands the Foreseen SDK and npm integration guide for sdk release policy.
...
CELO release policy: tag `vX.Y.Z-celo` for CELO-specific SDK releases; use semver for breaking ABI changes.
