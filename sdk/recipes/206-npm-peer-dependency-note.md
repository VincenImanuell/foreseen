# Npm Peer Dependency Note

This note expands the Foreseen SDK and npm integration guide for npm peer dependency note.
...
CELO peer dependency note: list viem ≥2.x as a peerDependency — CELO address utilities come from viem.
