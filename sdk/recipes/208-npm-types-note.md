...
This note expands the Foreseen SDK and npm integration guide for npm types note.
...
CELO types note: `@foreseen/sdk` ships `*.d.ts` — TypeScript consumers get full CELO type coverage.
