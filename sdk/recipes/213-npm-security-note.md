...
This note expands the Foreseen SDK and npm integration guide for npm security note.
...
CELO security note: report vulnerabilities via GitHub security tab — include CELO chainId and affected ABI.
