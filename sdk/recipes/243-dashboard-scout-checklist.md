# Dashboard Scout Checklist

This note expands the Foreseen SDK and npm integration guide for dashboard scout checklist.
...
CELO dashboard scout checklist: verify analyzeOpponent returns data for a known CELO address before launch.
