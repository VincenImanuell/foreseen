...
This note expands the Foreseen SDK and npm integration guide for sdk timeout policy.
...
CELO timeout policy: `claimCommitTimeout` after CELO commit window expires — don't leave CELO escrowed.
