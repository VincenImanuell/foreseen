...
This note expands the Foreseen SDK and npm integration guide for agent operator checklist.
...
CELO agent operator checklist: fund CELO wallet ≥ 0.1 CELO, set CELO_PRIVATE_KEY, verify chainId=42220.
