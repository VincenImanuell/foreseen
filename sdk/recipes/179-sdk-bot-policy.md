...
This note expands the Foreseen SDK and npm integration guide for sdk bot policy.
...
CELO bot policy: all CELO bots must be disclosed, rate-limited, and operate within match protocol rules.
