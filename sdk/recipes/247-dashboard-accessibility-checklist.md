...
This note expands the Foreseen SDK and npm integration guide for dashboard accessibility checklist.
...
CELO accessibility checklist: all CELO arena buttons must have aria-label and keyboard focus visible.
