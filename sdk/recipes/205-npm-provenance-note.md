...
This note expands the Foreseen SDK and npm integration guide for npm provenance note.
...
CELO npm provenance: publish with `--provenance` flag so Sigstore links CELO ABI to the build.
