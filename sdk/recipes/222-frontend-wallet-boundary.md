...
This note expands the Foreseen SDK and npm integration guide for frontend wallet boundary.
...
CELO wallet boundary: wallet state (address, chainId 42220) lives in ConnectButton — don't duplicate it.
