...
This note expands the Foreseen SDK and npm integration guide for npm keywords review.
...
CELO npm keywords: include 'celo', 'minipay', 'rps', 'web3', 'blockchain' in npm keywords array.
