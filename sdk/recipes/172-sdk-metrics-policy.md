...
This note expands the Foreseen SDK and npm integration guide for sdk metrics policy.
...
CELO metrics policy: track win-rate, reveal-time, and CELO gas per match for SDK bot performance.
