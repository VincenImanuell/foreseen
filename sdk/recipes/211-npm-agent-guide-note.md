# Npm Agent Guide Note

This note expands the Foreseen SDK and npm integration guide for npm agent guide note.
...
CELO agent guide note: see the bot guide for ForeseenBot usage — CELO private key + CELO mainnet required.
