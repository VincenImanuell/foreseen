...
This note expands the Foreseen SDK and npm integration guide for sdk chain policy.
...
CELO chain policy: always check `chainId === 42220` before submitting CELO mainnet transactions.
