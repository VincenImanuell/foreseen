...
This note expands the Foreseen SDK and npm integration guide for sdk install snippet.
...
CELO install snippet: `npm i @foreseen/sdk viem wagmi` — all three needed for CELO wallet interactions.
