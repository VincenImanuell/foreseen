# Sdk Open Feed Policy

This note expands the Foreseen SDK and npm integration guide for sdk open feed policy.
...
CELO open feed policy: paginate `getOpenMatches` results — large CELO match sets can slow the RPC call.
