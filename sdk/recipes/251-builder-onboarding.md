...
This note expands the Foreseen SDK and npm integration guide for builder onboarding.
...
CELO builder onboarding: install @foreseen/sdk, connect to CELO mainnet 42220, call getOpenMatches().
