# Agent Observer Checklist

This note expands the Foreseen SDK and npm integration guide for agent observer checklist.
...
CELO agent observer checklist: monitor CELO mainnet gas prices before deploying a high-frequency bot.
