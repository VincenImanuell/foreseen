...
This note expands the Foreseen SDK and npm integration guide for sdk error policy.
...
CELO error policy: surface Celoscan tx link in every CELO error banner so users can self-diagnose.
