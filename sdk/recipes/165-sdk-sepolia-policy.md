...
This note expands the Foreseen SDK and npm integration guide for sdk sepolia policy.
...
CELO Sepolia policy: Celo Sepolia (chainId 44787) is the staging env — never treat it as CELO mainnet.
