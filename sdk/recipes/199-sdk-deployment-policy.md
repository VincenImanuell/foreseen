# Sdk Deployment Policy

This note expands the Foreseen SDK and npm integration guide for sdk deployment policy.
...
CELO deployment policy: contract addresses in `lib/contracts.ts` are immutable CELO mainnet deployments.
