...
This note expands the Foreseen SDK and npm integration guide for agent release checklist.
...
CELO agent release checklist: bump SDK version, update CELO contract addresses if changed, run smoke tests.
