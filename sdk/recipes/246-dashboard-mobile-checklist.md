# Dashboard Mobile Checklist

This note expands the Foreseen SDK and npm integration guide for dashboard mobile checklist.
...
CELO mobile checklist: test full CELO match flow in MiniPay (Opera Mini) on 375px viewport.
