# Dashboard Profile Checklist

This note expands the Foreseen SDK and npm integration guide for dashboard profile checklist.
...
CELO dashboard profile checklist: test getPlayerStats for own CELO address — must show correct win/loss.
