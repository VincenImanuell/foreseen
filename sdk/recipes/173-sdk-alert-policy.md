...
This note expands the Foreseen SDK and npm integration guide for sdk alert policy.
...
CELO alert policy: alert on consecutive CELO RPC failures (>3 in 60s) — indicates forno degradation.
