...
This note expands the Foreseen SDK and npm integration guide for sdk indexer policy.
...
CELO indexer policy: avoid custom indexers if possible — RPSStats reads all CELO stats on-chain directly.
