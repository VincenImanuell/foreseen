...
This note expands the Foreseen SDK and npm integration guide for agent incident checklist.
...
CELO agent incident checklist: if CELO tx fails, check gas, chainId, RPC status, then Celoscan trace.
