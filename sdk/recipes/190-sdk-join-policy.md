...
This note expands the Foreseen SDK and npm integration guide for sdk join policy.
...
CELO join policy: verify opponent's CELO address is checksummed before joining — invalid addresses revert.
