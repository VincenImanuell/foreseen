...
This note expands the Foreseen SDK and npm integration guide for sdk withdraw policy.
...
CELO withdraw policy: call `withdraw()` within same session — CELO doesn't auto-transfer after settle.
