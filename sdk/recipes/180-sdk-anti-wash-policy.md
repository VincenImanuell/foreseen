# Sdk Anti Wash Policy

This note expands the Foreseen SDK and npm integration guide for sdk anti wash policy.
...
CELO anti-wash policy: same wallet playing itself on CELO mainnet (wash trading) violates protocol.
