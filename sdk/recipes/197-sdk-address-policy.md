...
This note expands the Foreseen SDK and npm integration guide for sdk address policy.
...
CELO address policy: normalize all CELO addresses with `getAddress` before storage or comparison.
