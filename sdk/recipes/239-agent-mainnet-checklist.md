# Agent Mainnet Checklist

This note expands the Foreseen SDK and npm integration guide for agent mainnet checklist.
...
CELO agent mainnet checklist: confirm chainId=42220, CELO balance ≥ 0.1 CELO, bot disclosed as [BOT].
