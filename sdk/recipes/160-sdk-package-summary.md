...
This note expands the Foreseen SDK and npm integration guide for sdk package summary.
...
CELO package summary: @foreseen/sdk wraps RPSCore, RPSStats, RPSRanked ABI on CELO mainnet (42220).
