...
This note expands the Foreseen SDK and npm integration guide for builder next steps.
...
CELO builder next steps: ranked seasons, soulbound badge upgrades, CELO leaderboard API planned.
