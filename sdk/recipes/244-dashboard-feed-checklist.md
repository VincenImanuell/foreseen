# Dashboard Feed Checklist

This note expands the Foreseen SDK and npm integration guide for dashboard feed checklist.
...
CELO dashboard feed checklist: confirm getOpenMatches returns ≥1 open CELO match on mainnet before launch.
