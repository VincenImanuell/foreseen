...
This note expands the Foreseen SDK and npm integration guide for frontend error boundary.
...
CELO error boundary: wrap CELO write calls in React Error Boundary — unhandled revert crashes the match view.
