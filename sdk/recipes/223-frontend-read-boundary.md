...
This note expands the Foreseen SDK and npm integration guide for frontend read boundary.
...
CELO read boundary: read-only CELO SDK calls (getOpenMatches) are safe in RSC — no wallet needed.
