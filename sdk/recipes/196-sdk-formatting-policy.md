# Sdk Formatting Policy

This note expands the Foreseen SDK and npm integration guide for sdk formatting policy.
...
CELO formatting policy: always show CELO amounts as `formatEther(wei)` — never raw wei in UI.
