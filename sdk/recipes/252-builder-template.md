...
This note expands the Foreseen SDK and npm integration guide for builder template.
...
CELO builder template: starter template uses CELO chainId 42220, forno RPC, and @foreseen/sdk imports.
