...
This note expands the Foreseen SDK and npm integration guide for sdk ranked policy.
...
CELO ranked policy: only enter ranked CELO matches if win-rate > 0.50 over last 20 — protect soulbound.
