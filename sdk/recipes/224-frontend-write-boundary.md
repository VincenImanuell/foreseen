...
This note expands the Foreseen SDK and npm integration guide for frontend write boundary.
...
CELO write boundary: write CELO SDK calls (commit, reveal, join) require 'use client' + wagmi wallet.
